...
- Do not claim autonomous research, independent model verification or production accuracy from synthetic tests.
- Office outputs require Microsoft Open XML SDK validation with zero errors.
- Keep README.md in English and README.zh-CN.md in Chinese.
